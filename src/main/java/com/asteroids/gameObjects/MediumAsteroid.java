...
public class MediumAsteroid extends GameObject{
    ...
    public MediumAsteroid(double posx, double posy) {
        super(MediumAsteroid.createPolygon(), posx, posy);
    }
    public MediumAsteroid() {
        super(MediumAsteroid.createPolygon());
